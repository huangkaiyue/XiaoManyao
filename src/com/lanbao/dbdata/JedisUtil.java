...
//    private static String ADDR_ARRAY = "10.61.17.155";  
    ...
    private static void initialPool() {  
        try {  
            ...
            System.out.println("get  JedisPool: ok" );  
        } catch (Exception e) {  
...
//            jedisPool.close();
     ...
     * @param value 
     */  
    public synchronized static void setHString(String key,String field, String value) {  
        try {  
     ...
     * @return value 
     */  
    public synchronized static List<String> getHashMapString(String key, String... fields) {  
        if (getJedis() == null || !getJedis().exists(key)) {  
            return null;  
        }  
    	...
    	new Thread(new Runnable() {
			...
			public void run() {
		    	...
		    	for(int i=0;i<100;i++){
		    		...
		    		String val= getString("kaiyue");
		    		System.out.println("Thread val :"+val);
		    	}
			}
		}).start();
    	for(int i=0;i<100;i++){
    		setString("kaiyue", "9876"+i);
    		try {
				Thread.sleep(120);
			} catch (InterruptedException e) {
				// TODO Auto-generated catch block
